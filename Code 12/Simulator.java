...
public class Simulator
{
    ...
    private static final double TIGER_CREATION_PROBABILITY = 0.047;
    ...
    protected double RAIN_PROBABILITY = 0.549;
    ...
    private void populate()
    {
        ...
        Snake illSnake = new Snake(true, field, randLocation);
        illSnake.infect();
        actors.add(illSnake);
    ...
    /**
     * Using condition to check is at night time or not
     * @return true if is at night time
     */
