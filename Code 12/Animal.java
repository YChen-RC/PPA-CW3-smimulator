...
public abstract class Animal implements Actor
{
    ...
    private double INFECT_PROBABILITY = 0.17;
    //Heal rate after infected the disease
    private double HEAL_RATE = 0.18;
    ...
    {
        if(isInfected && rand.nextDouble() < getLethalityRate()) {
            setDead();
            numInfectionDeath ++;
        }
    }
    ...
    abstract protected double getLethalityRate();
}
